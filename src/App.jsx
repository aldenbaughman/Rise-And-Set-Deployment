...
function App() {
  ...
  async function GeminiLocationInfo(){
        try {
            //rise-and-set-afabb899261f.herokuapp.com
            const response = await fetch('https://rise-and-set-afabb899261f.herokuapp.com/chat', {
                method: "POST",
                headers: {
            ...
            if (location != 'Waiting for input' && location != historyElem[2]){
              ...
              fetch('https://rise-and-set-afabb899261f.herokuapp.com:8888/add', {
                  method: 'POST', 
                  headers: {
                      'Content-Type': 'application/json'
                  },
